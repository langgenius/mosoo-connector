...
var Specs = []runtime.CommandSpec{
	...
	},
	{
		...
		OperationID:     "console_appDeploymentRunList",
		Method:          "POST",
		PathTpl:         "/graphql",
		DefaultHostname: "http://127.0.0.1:8787/api",
		Params: []runtime.ParamSpec{
		...
		RequestBody: &runtime.RequestBody{
			Required:  true,
			MediaType: "application/json",
			Schema:    &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"appId": &runtime.SchemaSpec{Type: "string"}, "limit": &runtime.SchemaSpec{Type: "integer"}}, Required: []string{"appId"}},
			Template:  "{\"query\":\"query appDeploymentRunList($appId: ULID!, $limit: Int) { appDeploymentRunList(appId: $appId, limit: $limit) { appId createdAt deploymentId errorCode errorMessage id liveUrl plannedUrl sourceBranch sourceCommitSha status targetKind updatedAt } }\",\"variables\":{}}",
			MergePath: "variables",
		},
	},
	{
		Group: "Apps",
		Use:   "app-deployment-secret-list",
		Short: "List app deployment secrets",
		Long:  "List app deployment secrets via the mosoo Console GraphQL API (Apps surface). Requires a personal access token logged in to the /api host.",
		Notes: []string{"Uses POST /graphql on the console default hostname (/api)."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
		OperationID:     "console_appDeploymentSecretList",
		Method:          "POST",
		PathTpl:         "/graphql",
		DefaultHostname: "http://127.0.0.1:8787/api",
		Params: []runtime.ParamSpec{
		...
		RequestBody: &runtime.RequestBody{
			...
			MediaType: "application/json",
			Schema:    &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"appId": &runtime.SchemaSpec{Type: "string"}}, Required: []string{"appId"}},
			Template:  "{\"query\":\"query appDeploymentSecretList($appId: ULID!) { appDeploymentSecretList(appId: $appId) { appId createdAt name updatedAt } }\",\"variables\":{}}",
			MergePath: "variables",
		},
	},
	{
	...
	{
		Group: "Apps",
		Use:   "delete-app-deployment-secret",
		Short: "Delete an app deployment secret",
		Long:  "Delete an app deployment secret via the mosoo Console GraphQL API (Apps surface). Requires a personal access token logged in to the /api host.",
		Notes: []string{"Uses POST /graphql on the console default hostname (/api)."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
		OperationID:     "console_deleteAppDeploymentSecret",
		Method:          "POST",
		PathTpl:         "/graphql",
		DefaultHostname: "http://127.0.0.1:8787/api",
		Params: []runtime.ParamSpec{
		...
		RequestBody: &runtime.RequestBody{
			...
			Template:  "{\"query\":\"mutation deleteAppDeploymentSecret($input: DeleteAppDeploymentSecretInput!) { deleteAppDeploymentSecret(input: $input) { ok } }\",\"variables\":{\"input\":{}}}",
			MergePath: "variables",
		},
	},
	{
	...
	{
		Group: "Apps",
		Use:   "set-app-deployment-secret",
		Short: "Set app deployment secret",
		Long:  "Set app deployment secret via the mosoo Console GraphQL API (Apps surface). Requires a personal access token logged in to the /api host.",
		Notes: []string{"Uses POST /graphql on the console default hostname (/api)."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
		OperationID:     "console_setAppDeploymentSecret",
		Method:          "POST",
		PathTpl:         "/graphql",
		DefaultHostname: "http://127.0.0.1:8787/api",
		Params: []runtime.ParamSpec{
		...
		RequestBody: &runtime.RequestBody{
			Required:  true,
			MediaType: "application/json",
			Schema:    &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"input": &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"appId": &runtime.SchemaSpec{Type: "string"}, "name": &runtime.SchemaSpec{Type: "string"}, "value": &runtime.SchemaSpec{Type: "string"}}, Required: []string{"appId", "name", "value"}}}, Required: []string{"input"}},
			Template:  "{\"query\":\"mutation setAppDeploymentSecret($input: SetAppDeploymentSecretInput!) { setAppDeploymentSecret(input: $input) { appId createdAt name updatedAt } }\",\"variables\":{\"input\":{}}}",
			MergePath: "variables",
		},
	},
	{
	...
	},
	{
		...
		OperationID:     "console_updateAppMcpServer",
		Method:          "POST",
		PathTpl:         "/graphql",
		DefaultHostname: "http://127.0.0.1:8787/api",
		Params: []runtime.ParamSpec{
		...
		RequestBody: &runtime.RequestBody{
			Required:  true,
			MediaType: "application/json",
			Schema:    &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"input": &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"appId": &runtime.SchemaSpec{Type: "string"}, "description": &runtime.SchemaSpec{Type: "string"}, "iconUrl": &runtime.SchemaSpec{Type: "string"}, "name": &runtime.SchemaSpec{Type: "string"}, "serverId": &runtime.SchemaSpec{Type: "string"}, "url": &runtime.SchemaSpec{Type: "string"}}, Required: []string{"appId", "name", "serverId", "url"}}}, Required: []string{"input"}},
			Template:  "{\"query\":\"mutation updateAppMcpServer($input: UpdateAppMcpServerInput!) { updateAppMcpServer(input: $input) { authType authorizationState createdAt credential { authType createdAt expiresAt id scope scopeValues status subjectLabel updatedAt } credentialScope credentialStatus description enabled hasCredential iconUrl id name ownerId ownerName appId source updatedAt url } }\",\"variables\":{\"input\":{}}}",
			MergePath: "variables",
		},
	},
	{
	...
	{
		Group: "Sessions",
		Use:   "bound-capability-run-provenance",
		Short: "Bound capability run provenance",
		Long:  "Bound capability run provenance via the mosoo Console GraphQL API (Sessions surface). Requires a personal access token logged in to the /api host.",
		Notes: []string{"Uses POST /graphql on the console default hostname (/api)."},
		KnownErrors: []runtime.KnownError{
			{Status: 401, Cause: "Missing, invalid, or revoked personal access token."},
		},
		OperationID:     "console_boundCapabilityRunProvenance",
		Method:          "POST",
		PathTpl:         "/graphql",
		DefaultHostname: "http://127.0.0.1:8787/api",
		Params: []runtime.ParamSpec{
			{Name: "appId", Flag: "app-id", In: "variable", GoType: "string", Help: "appId (variable, required)", Required: true},
			{Name: "runId", Flag: "run-id", In: "variable", GoType: "string", Help: "runId (variable, required)", Required: true},
		},
		RequestBody: &runtime.RequestBody{
			Required:  true,
			MediaType: "application/json",
			Schema:    &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"appId": &runtime.SchemaSpec{Type: "string"}, "runId": &runtime.SchemaSpec{Type: "string"}}, Required: []string{"appId", "runId"}},
			Template:  "{\"query\":\"query boundCapabilityRunProvenance($appId: ULID!, $runId: ULID!) { boundCapabilityRunProvenance(appId: $appId, runId: $runId) { agentId appId bindingEnv bindingName deploymentId deploymentRunId runId } }\",\"variables\":{}}",
			MergePath: "variables",
		},
	},
	{
	...
	},
	{
		...
		RequestBody: &runtime.RequestBody{
			...
			MediaType: "application/json",
			Schema:    &runtime.SchemaSpec{Type: "object", Properties: map[string]*runtime.SchemaSpec{"appId": &runtime.SchemaSpec{Type: "string"}}, Required: []string{"appId"}},
			Template:  "{\"query\":\"query appSkillList($appId: ULID!) { appSkillList(appId: $appId) { author createdAt description fileCount forkOrigin { name ownerName skillId } id name ownerId ownerName appId snapshotId sourceKind updatedAt } }\",\"variables\":{}}",
			MergePath: "variables",
		},
	},
	{
		...
		RequestBody: &runtime.RequestBody{
			...
			Template:  "{\"query\":\"mutation createSkillFork($input: CreateSkillForkInput!) { createSkillFork(input: $input) { author createdAt description fileCount forkOrigin { name ownerName skillId } id name ownerId ownerName appId snapshotId sourceKind updatedAt } }\",\"variables\":{\"input\":{}}}",
			MergePath: "variables",
		},
	},
	{
